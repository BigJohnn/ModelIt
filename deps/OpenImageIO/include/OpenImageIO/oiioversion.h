...
namespace OpenImageIO_v2_5_2 { }
namespace OIIO = OpenImageIO_v2_5_2;

// Macros to use in each file to enter and exit the right name spaces.
#define OIIO_NAMESPACE OpenImageIO_v2_5_2
#define OIIO_NAMESPACE_STRING "OpenImageIO_v2_5_2"
#define OIIO_NAMESPACE_BEGIN namespace OpenImageIO_v2_5_2 {
