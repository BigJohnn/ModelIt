 ...
 */
#define VL_OS_IOS
#if ( defined(VL_OS_LINUX) || defined(VL_OS_MACOSX)) && (defined(VL_COMPILER_GNUC) || defined(VL_COMPILER_CLANG))
static void vl_constructor (void) __attribute__ ((constructor)) ;
static void vl_destructor (void) __attribute__ ((destructor))  ;
#endif
